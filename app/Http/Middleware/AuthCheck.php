...
class AuthCheck
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if (session()->has('LoggedCustomer') && ($request->path() != 'customer/myorder' && $request->path() != 'customer/home' && $request->path() != 'customer/profile' && $request->path() != 'customer/search' && $request->path() != 'customer/content/{id}' && $request->path() != 'customer/content/{id}/orderContent' && $request->path() != 'customer/myorder/{orderId}')) {
            return back();
        }
