                 ...
                 <label for="tab-2" class="tab">Түрээслүүлэгч</label>
                    <div class="login-space">
                        <div class="login">
                            ...
                            @endif
                            <div class="group"> 
                                 <input name ="ovog" type="text" class="input" placeholder="Овог" value="{{ old('ovog')}}">
                                ...
                                <input name ="email" type="text" class="input" placeholder="Цахим хаяг" value="{{ old('email')}}"> 
                                <span class="text-danger">@error('email'){{$message}}@enderror</span>
                                <input name ="phone" type="text" class="input" placeholder="Утас" value="{{ old('phone')}}"> 
                                <span class="text-danger">@error('phone'){{$message}}@enderror</span>
                                <input name ="register" type="text" class="input" placeholder="Регистэр" value="{{ old('register')}}"> 
                                <span class="text-danger">@error('register'){{$message}}@enderror</span>
                                 <input name ="address" type="text" class="input" placeholder="Хаяг" value="{{ old('address')}}"> 
